...
function Searchpanel() {
  ...
  return (
    <div className="md: m-auto w-[100%] max-w-7xl px-5 md:px-0">
      <p className="mt-32  font-serif text-[3rem] font-semibold  text-gray-300 sm:text-[4rem] ">
        Teacher Details
      </p>

      <section className="mt-10 flex w-[100%] items-center justify-between  rounded-3xl bg-[#7c7c7c2b] px-5 py-5 ">
        <select
          ref={day}
          id="Days"
